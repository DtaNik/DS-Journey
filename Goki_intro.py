...
if('goki' in converse.lower()):
    print( "Hi "+Fst_name+",\nHow can i help you?")
    give_instruction=str(raw_input())
    if('take care of ' in give_instruction.lower() and 'PACE' in give_instruction.upper()):
        execfile("//hewitt.com/apfs/India/Gurgaon/GURDAT13/BPO/BEACONS/IEG/Team Folder/Team IEG GGN/Nikhil Chauhan/Python/prog.py")
    else:
